class Calculator{
    ...
    updateDisplay(){
        this.currentOperandsTextElement.innerText = this.getDisplayNumber(this.currentOperand)
        if (this.operation != null) {
            this.previousOperandsTextElement.innerText = `${this.previousOperand} ${this.operation}`
        }else{
